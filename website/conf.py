...
BLOG_AUTHOR = "Club de Jaqueo"
BLOG_TITLE = "рефлектор"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://reflektor.protocultura.net/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "reflektor@protocultura.net"
BLOG_DESCRIPTION = "РЕФЛЕКТОР (reflektor)"
...
# REDIRECTIONS = []
REDIRECTIONS = [
    ("index.html", "/reflektor/"),
    ("galleries/reflektor/index.html", "/galleries/reflektor/rolodex.html"),
    ("es/index.html", "/es/reflektor/"),
]
...
DEPLOY_COMMANDS = [
    "rsync -rav output/* alecu@protocultura.net:/www/reflektor.protocultura.net"
]
...
# Default is ''
CONTENT_FOOTER = '<br><hr>&copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="http://getnikola.com">Nikola</a>         {license}'
